...
This is useful if you mainly work with the player entities, rather than with player objects.

To set aliases you need to call `server_replicator:add_player_alias(player, alias)`
...
This is important to do when a player leaves the game.
