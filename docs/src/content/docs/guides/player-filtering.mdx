...
You can add a [non-ready](/replecs/started/starting-replication#activating-players) player to the filter, but it wont replicate until the player is marked as ready. 
